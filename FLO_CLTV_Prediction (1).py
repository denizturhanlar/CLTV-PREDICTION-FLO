...
# GÖREV 1: Veriyi Hazırlama
###############################################################
#gerekli kütüpahenler indirildi
import pandas as pd
...
# 1. flo_data_20K.csv verisini okuyunuz.Dataframe’in kopyasını oluşturunuz.
df_ = pd.read_csv("pythonProject/WEEK03/flo_data_20k.csv")
df = df_.copy()
df.head()
df.describe().T
#bu şekilde describe bakabilirim
...
#order num total : spiariş verdiği platform
#customer value total : platformlardan yaptığı totla harcamlar
...
#apply(pd.to_datetime) kullanarak çeviriyoruz
